...
package br.edu.ufcspa.isolationapp.database;
 ...
 * thanks to FolioProject developed on Unasus UFCSPA!!
 */
...
public class DataBaseAdapter {
    ...
    private static String TB_CONDICAO = "condicao";
    private static String TB_EPI = "EPI";
    ...
    public List<Condicao>buscarCondicaoPorNome(String nome){
        Condicao condicao;
        ArrayList<Condicao> lista = new ArrayList<>();
        Cursor c = null;
        String query = "SELECT * FROM ".concat(TB_CONDICAO) + " WHERE infeccao_condicao LIKE '%"+nome+"%';";
        c = db.rawQuery(query, null);
        if (c.moveToFirst()) {
            do {
                condicao = new Condicao(c.getInt(0), c.getString(1), c.getString(2), c.getString(3),c.getString(4));
    ...
    public List<Epi>buscarEPIs(){
        ...
        Cursor c = null;
        String query = "SELECT * FROM ".concat(TB_EPI);
        c = db.rawQuery(query, null);
        if (c.moveToFirst()) {
            do {
                epi = new Epi(c.getInt(0), c.getString(1), c.getString(2), c.getString(3),c.getString(4));
                lista.add(epi);
            } while (c.moveToNext());
        }
        return lista;
